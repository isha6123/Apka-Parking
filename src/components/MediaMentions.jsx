...
const mediaMentions = [
  {
    id: 1,
    logo: gw,
    title: "Park+, building a super app for car owners",
  ...
  },
  {
    id: 2,
    logo: mobility,
    title: "Mooving, Park+ to deploy 2,000 battery swapping stations",
  ...
  },
  {
    id: 4,
    logo: toi,
    title: "After Gurugram, Park+ ties up with Noida mall for vaccination",
...
// // Sample Media Mentions Data
// const mediaMentions = [
//   {
//     id: 1,
//     logo: "src\assets\GW.jpg",
//     title: "Park+, building a super app for car owners",
//     content: "India has more car owners than parking slots...",
//     author: "MANU BALACHANDRAN",
//     date: "November 28, 2022",
...
//           <span className="text-indigo-400 text-6xl mr-2">❝</span>
//           Media Mentions
//         </h2>
//       </div>
...
//       <div className="relative mt-10 max-w-7xl mx-auto">
//         {/* Custom Navigation Buttons */}
//         <button className="absolute left-0 top-1/2 transform -translate-y-1/2 bg-white p-3 shadow-lg rounded-full z-10 hover:bg-gray-200">
...
//           {mediaMentions.map((item) => (
//             <SwiperSlide key={item.id}>
//               <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-2xl transition-all duration-300">
//                 <img src={item.logo} alt={item.title} className="w-16 mb-2" />
//                 <h3 className="text-lg font-semibold text-indigo-600">
//                   {item.title}
//                 </h3>
//                 <p className="text-gray-500 mt-2 text-sm">{item.content}</p>
//                 <a href={item.link} className="text-indigo-500 font-medium mt-2 block hover:underline">
//                   Read more...
//                 </a>
//                 <p className="text-gray-400 text-sm mt-2">by {item.author}</p>
//                 <p className="text-gray-400 text-xs">{item.date}</p>
//               </div>
//             </SwiperSlide>
//           ))}
...
//         <button className="absolute right-0 top-1/2 transform -translate-y-1/2 bg-white p-3 shadow-lg rounded-full z-10 hover:bg-gray-200">
